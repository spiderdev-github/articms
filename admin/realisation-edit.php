...
<div class="row">
  <div class="col-lg-5">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="realisations.php" class="btn btn-sm btn-secondary">
      ...
      <div class="card-footer d-flex" style="gap:8px;">
         <button class="btn btn-primary" type="submit">
          ...
          <a class="btn btn-secondary ml-2" href="realisations.php"><i class="fas fa-times"></i>  Annuler</a>
      </div>
      </form>
    </div>
  </div>
  <div class="col-lg-7">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
          <h3 class="card-title"><i class="fas fa-images mr-1"></i> Galerie images</h3>
      </div>
      <div class="card-body">
